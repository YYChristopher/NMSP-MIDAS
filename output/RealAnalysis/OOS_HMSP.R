...
work_dir = 'F:/24561/Documents/ResearchWrite/NHMM-MIDAS/Submission Requirements/Code/SomeResults/RealAnalysis'
...
GDP = read.csv('GDP2.csv', header = TRUE)
GDP_noindex <- GDP['GDP']
...
predmat = read.table("PredState/predsave_HMSP.txt", header = FALSE, sep = " ")
...
m_mon <- 3
NBER = read.csv('USREC.csv', header = TRUE)
...
ggsave("Plots/HMSP-OUT.png", plot = plot.gdp.growth.test.color, width = 12, height = 7, units = "in", dpi = 600)
